...
basic-memory project create my-novel ~/writing/my-novel
...
<Accordion title="Too many scattered notes, hard to find information">
**Solutions:**
...
<Accordion title="Character details becoming inconsistent">
**Solutions:**
...
<Accordion title="Plot holes and continuity errors">
**Solutions:**
...
<CardGroup cols={2}>
  ...
  <Card title="Note Taking" icon="edit" href="/how-to/note-taking">
  ...
  <Card title="Personal Knowledge" icon="brain" href="/how-to/personal-knowledge">
