...
basic-memory project create my-project ~/code/my-project/docs
...
- [ ] Sync documentation: `basic-memory sync`
...
<Accordion title="Documentation getting out of sync with code">
**Solutions:**
...
<Accordion title="Team not following documentation patterns">
**Solutions:**
...
<Accordion title="Finding relevant documentation is difficult">
**Solutions:**
...
<CardGroup cols={2}>
  <Card title="Architecture Decisions" icon="sitemap" href="/how-to/architecture-decisions">
