...
<CardGroup cols={2}>
  <Card title="Knowledge Creation" icon="pen-tool">
  ...
  <Card title="Context Building" icon="link">
  ...
  <Card title="Visual Note Display" icon="eye">
...
<Accordion title="Claude can't find Basic Memory tools">
**Solutions:**
