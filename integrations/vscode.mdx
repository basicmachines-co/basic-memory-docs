...
<CardGroup cols={2}>
  ...
  <Card title="Instant Sync" icon="refresh">
    Changes automatically sync to knowledge graph
  </Card>
  <Card title="Search Integration" icon="search">
...
<Accordion title="VS Code not recognizing markdown files">
**Solutions:**
...
<Accordion title="Basic Memory sync not working">
**Solutions:**
...
<Accordion title="Search not finding content">
**Solutions:**
