...
<Accordion title="Claude Code can't access Basic Memory">
**Solutions:**
...
<Accordion title="Context not loading from memory:// URLs">
**Solutions:**
...
<CardGroup cols={2}>
  ...
  <Card title="File Editing" icon="edit">
    Edit Basic Memory notes directly and sync manually
  </Card>
  <Card title="Manual Context" icon="copy">
    Copy content from Basic Memory into conversations
  </Card>
  <Card title="Parallel Usage" icon="split">
    Use Claude Desktop alongside Claude Code
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Project Documentation" icon="folder" href="/how-to/project-documentation">
  ...
  <Card title="Knowledge Format" icon="file-text" href="/guides/knowledge-format">
