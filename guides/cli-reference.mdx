---
title: "CLI Reference"
description: "Complete command line reference for Basic Memory including auth, sync, import, project management, and tool commands"
---
...
<Info>
You can then use the `/mcp` command in the REPL to check MCP server status and interact with Basic Memory tools directly.
</Info>
...
`0.13.0` (manual git tags)
</Card>
<Card title="Beta" icon="flask">
`0.13.0b1` (manual git tags)
</Card>
<Card title="Development" icon="code">
`0.12.4.dev26+468a22f` (automatic from commits)
</Card>
</CardGroup>
