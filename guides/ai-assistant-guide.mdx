...
description: 'A comprehensive guide for AI assistants to effectively use Basic Memory tools through the Model Context Protocol (MCP)'
icon: 'brain'
---
...
<CardGroup cols={2}>
  <Card title="Essential Tools" icon="tools">
  ...
  <Card title="Project Management (v0.13.0)" icon="folder">
...
```text Follow Relations
memory://path/relation_type/*
```

```text Find Relations to Target
memory://path/*/target
```
</CodeGroup>
...
<Card title="Always consider recording context when" icon="lightbulb">
...
<AccordionGroup>
  <Accordion title="Creating knowledge">
    ```
  ...
  <Accordion title="Referencing existing knowledge">
    ```
  ...
  <Accordion title="Finding information">
    ```
  ...
  <Accordion title="Editing existing notes (v0.13.0)">
    ```
  ...
  <Accordion title="Project management (v0.13.0)">
    ```
  ...
  <Accordion title="File organization (v0.13.0)">
    ```
...
<CardGroup cols={2}>
  <Card title="Files are Truth" icon="file">
  ...
  <Card title="Building Context Effectively" icon="network-wired">
  ...
  <Card title="Writing Knowledge Wisely" icon="pencil">
  ...
  <Card title="Leverage v0.13.0 Features" icon="star">
...
<AccordionGroup>
  ...
  <Accordion title="Strict Mode for Edit/Move Operations">
...
<Steps>
  <Step title="Offer to capture important discussions">
    Record decisions, rationales, and conclusions
  </Step>
  <Step title="Link to related topics">
...
<Card title="Graph Building Guidelines" icon="share-nodes">
